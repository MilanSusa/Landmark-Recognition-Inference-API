"""
Django settings for landmark_recognition project.
...
SECRET_KEY = os.environ['LANDMARK_RECOGNITION_DJANGO_SECRET_KEY']
...
ROOT_URLCONF = 'landmark_recognition.urls'
...
WSGI_APPLICATION = 'landmark_recognition.wsgi.application'
